...
# Load data
data = pd.read_csv(r"C:\Users\LENOVO\OneDrive\Desktop\projects\heart attack predection\Heart Attack.csv")
...
prediction_label = Label(root, text="HEART ATTACK PREDICTION ", fg="blue", font=("Arial", 15, "bold"))
